...
import { ModelSelection, ProjectScript, ProjectThreadLaunchPreference } from "@t3tools/contracts";
    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.threadLaunchPreference !== null ? JSON.stringify(row.threadLaunchPreference) : null},
        ...
        DO UPDATE SET
          ...
          thread_launch_preference_json = excluded.thread_launch_preference_json,
