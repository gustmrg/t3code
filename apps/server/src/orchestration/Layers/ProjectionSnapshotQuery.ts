...
const ProjectionProjectDbRowSchema = ProjectionProject.mapFields(
  Struct.assign({
    ...
    threadLaunchPreference: Schema.NullOr(Schema.fromJsonString(ProjectThreadLaunchPreference)),
...
const ProjectionThreadDbRowSchema = ProjectionThread.mapFields(
  Struct.assign({
    ...
    terminalWorkspace: Schema.NullOr(Schema.fromJsonString(TerminalWorkspaceBinding)),
...
function mapProjectShellRow(
  ...
  return {
    ...
    threadLaunchPreference: row.threadLaunchPreference,
    ...
    execute: () =>
      sql`
        SELECT
          ...
          thread_launch_preference_json AS "threadLaunchPreference",
    ...
    execute: () =>
      sql`
        SELECT
          ...
          terminal_workspace_json AS "terminalWorkspace",
          ...
          ([
            ...
            Effect.gen(function* () {
              ...
              const threads: ReadonlyArray<OrchestrationThread> = threadRows.map((row) => ({
                ...
                ...(row.terminalWorkspace === null
                  ? {}
                  : { terminalWorkspace: row.terminalWorkspace }),
            ...
            : repositoryIdentityResolver.resolve(option.value.workspaceRoot).pipe(
                Effect.map((repositoryIdentity) =>
                  Option.some({
                    ...
                    threadLaunchPreference: option.value.threadLaunchPreference,
  ...
  const getThreadShellById: ProjectionSnapshotQueryShape["getThreadShellById"] = (threadId) =>
    Effect.gen(function* () {
      ...
      return Option.some({
        ...
        worktreePath: threadRow.value.worktreePath,
        ...(threadRow.value.terminalWorkspace === null
          ? {}
          : { terminalWorkspace: threadRow.value.terminalWorkspace }),
