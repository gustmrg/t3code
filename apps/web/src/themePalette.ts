...
export const GUSTY_CODE_THEME_LABEL = "Gusty Code";
...
export type ThemeDefinition = Readonly<{
  ...
  /** Legacy theme-file metadata, retained for round trips; no longer affects rendering. */
...
// Saved selections and mixed halves remain readable after the rebrand.
...
const GUSTY_CODE_LIGHT_COLORS: ThemeColors = {
  canvas: "#f8fafc",
  chrome: "#f8fafc",
  toolbar: "#f8fafc",
  toolbarForeground: "#0b1020",
  toolbarBorder: "#cbd5e1",
  toolbarControl: "#ffffff",
  toolbarControlForeground: "#0b1020",
  toolbarControlHover: "#e2e8f0",
  surface: "#ffffff",
  ...
  updateSurface: "#e2e8f0",
  accentSurface: "#e2e8f0",
  accentSurfaceForeground: "#0b1020",
  messageSurface: "#e2e8f0",
  messageForeground: "#0b1020",
  messageAction: "#2563eb",
  messageActionForeground: "#ffffff",
  messageActionHover: "#1d4ed8",
  codeBackground: "#f8fafc",
  codeForeground: "#0b1020",
  sidebar: "#f8fafc",
  sidebarForeground: "#0b1020",
  sidebarMutedForeground: "#475569",
  sidebarControlSurface: "#ffffff",
  sidebarRowHover: "#e2e8f0",
  sidebarRowActive: "#e2e8f0",
  sidebarRowSelected: "#e2e8f0",
  sidebarBorder: "#cbd5e1",
  terminalBackground: "#f8fafc",
  terminalForeground: "#0b1020",
  terminalCursor: "#2563eb",
  terminalSelection: "#e2e8f0",
  terminalScrollbar: "#cbd5e1",
  terminalScrollbarHover: "#64748b",
};

const GUSTY_CODE_DARK_COLORS: ThemeColors = {
  canvas: "#0b1020",
  chrome: "#0b1020",
  toolbar: "#0b1020",
  toolbarForeground: "#e5e7eb",
  toolbarBorder: "#334155",
  toolbarControl: "#111a2e",
  toolbarControlForeground: "#e5e7eb",
  toolbarControlHover: "#1e293b",
  surface: "#111a2e",
  surfaceRaised: "#111a2e",
  surfaceOverlay: "#111a2e",
  text: "#e5e7eb",
  textMuted: "#94a3b8",
  border: "#334155",
  input: "#64748b",
  ...
  warningSurface: "#332812",
  update: "#2563eb",
  updateForeground: "#60a5fa",
  updateSurface: "#1e293b",
  accentSurface: "#1e293b",
  accentSurfaceForeground: "#e5e7eb",
  messageSurface: "#1e293b",
  messageForeground: "#e5e7eb",
  messageAction: "#2563eb",
  messageActionForeground: "#ffffff",
  messageActionHover: "#1d4ed8",
  ...
  sidebarControlSurface: "#111a2e",
  sidebarRowHover: "#1e293b",
  sidebarRowActive: "#1e293b",
  sidebarRowSelected: "#1e293b",
  sidebarBorder: "#334155",
  terminalBackground: "#0b1020",
  terminalForeground: "#e5e7eb",
  terminalCursor: "#06b6d4",
  terminalSelection: "#1e293b",
  terminalScrollbar: "#334155",
  terminalScrollbarHover: "#64748b",
};
 ...
 * carries the flagship Gusty Code palette used to fill roles omitted by theme
 * files.
 */
...
/**
 * The status colors Gusty Code shows without a theme, read from the app's own
...
export function getDefaultThemeColors(appearance: ThemeAppearance): ThemeColors {
  return appearance === "dark" ? GUSTY_CODE_DARK_COLORS : GUSTY_CODE_LIGHT_COLORS;
}

/**
 * A companion action color for the secondary action. This gives send buttons,
